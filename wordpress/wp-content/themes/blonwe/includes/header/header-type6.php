...
<header id="masthead" class="site-header  <?php echo esc_attr($headertransparent); ?> header-type6">
    <div class="header-desktop min-1200">
	
        <div class="header-row header-topbar color-scheme-light color-layout-dark background-black">
			<div class="container">
        ...
        <div class="header-row header-main color-scheme-dark color-layout-white bordered-bottom border-theme-10">
			<div class="container">
				<div class="header-inner d-flex">
					...
					<div class="col d-inline-flex align-items-center justify-content-center center">
        ...
        <div class="header-row header-bottom color-scheme-dark color-layout-white bordered-bottom border-theme-15">
			<div class="container">
				<div class="header-inner d-flex">
					<div class="col d-inline-flex align-items-center justify-content-center">
						<nav class="klb-menu-nav horizontal primary-menu menu-seperate color-scheme-white border-gray sub-shadow-md">
							<?php 
							wp_nav_menu(array(
